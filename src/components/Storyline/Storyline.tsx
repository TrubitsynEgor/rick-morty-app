...
import { Container, MainCharacters } from '..';
  ...
  return (
    <div className={cn(styles.storyline, className)} {...props}>
      <Container className={styles.container}>
        <h2 className={styles.title}><StorylineSVG /> Storyline:</h2>
        ...
        <h2 className={cn(styles.title, styles.left)}> Main characters: <img src={CharactersImg} alt="R&M" className={styles.img} /> </h2>
